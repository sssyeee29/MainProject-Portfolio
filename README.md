...
# 1. 프로젝트 소개
### 🌳 ECOVERY이란 ? <br>
  "에코버리는 AI 기반 대형폐기물 분류를 비롯해, 분리배출 신고, 친환경 중고거래, 재활용 상품 판매, 환경 뉴스 제공까지 한 번에 제공하는 통합 환경 플랫폼입니다. 헷갈리는 품목도 간편하게 신고하고, 필요한 물건을 나누며, 합리적인 가격으로 재활용 제품을 구매하고, 신뢰할 수 있는 환경 정보를 한 곳에서 확인할 수 있습니다." 
